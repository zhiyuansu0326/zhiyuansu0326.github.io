...
<div class="cv-section">
  <div class="cv-item">
    <div class="cv-item-logo">
      <img src="./assets/img/mitacs_logo_1.png" alt="Mitacs logo" />
    </div>
    <div class="cv-item-main">
      <div class="cv-item-header">
        ...
        <div class="cv-item-side">
          <div class="cv-item-location">Halifax, NS, Canada</div>
          <div class="cv-item-time">Jul 2025 - Oct 2025</div>
        </div>
      </div>
  ...
  <div class="cv-item">
    <div class="cv-item-logo">
      <img src="./assets/img/baidu_logo.png" alt="Baidu logo" />
    </div>
    <div class="cv-item-main">
      <div class="cv-item-header">
        <div class="cv-item-school"><a href="https://ir.baidu.com/" target="_blank" rel="noopener">Baidu Inc.</a></div>
        <div class="cv-item-side">
          <div class="cv-item-location">Beijing, China</div>
          <div class="cv-item-time">May 2024 - Sep 2024</div>
        </div>
      </div>
      <div class="cv-item-meta cv-item-degree">Summer Intern</div>
    </div>
  </div>
</div>
